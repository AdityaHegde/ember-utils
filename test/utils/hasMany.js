...
test("Simple hasMany", function() {
  ...
  classObj = Ember.Object.extend({
    arr1 : hasMany(),
    arr2 : hasMany(classChild),
    arr3 : hasMany("Ember.ClassChild"),
  });
...
test("hasMany with map", function() {
  var 
  ...
  classObj = Ember.Object.extend({
    arr1 : hasMany(map, "varb", "c1"),
    arr2 : hasMany("Ember.HasManyMap", "varb", "c1"),
  });
